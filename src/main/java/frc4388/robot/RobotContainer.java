...
public class RobotContainer {
  ...
  public void setControls(Mode mode) {
    ...
    if (mode == Mode.COMPETITIVE) {
      drumShooterTargetPIDVelocity = 12000;
  ...
  /**
   * Gets the {@link edu.wpi.first.wpilibj.GenericHID#GenericHID(int) Generic HID} for the Operator
   * Xbox Controller. Generic HIDs/Joysticks can be used to set up JoystickButtons.
   * @return The IHandController interface for the Operator Controller.
   */
  ...
  /**
   * Gets the {@link edu.wpi.first.wpilibj.GenericHID#GenericHID(int) Generic HID} for the Driver Xbox
   * Controller. Generic HIDs/Joysticks can be used to set up JoystickButtons.
